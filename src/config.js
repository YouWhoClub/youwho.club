...
export const API_CONFIG = {
    AUTH_API_URL: ISLOCALHOST ? `${LOCAL_URL}:3434/auth` : 'https://panel.home.youwho.club/user',
    HEALTH_API_URL: ISLOCALHOST ? `${LOCAL_URL}:3434/auth` : 'https://panel.home.youwho.club/health',
