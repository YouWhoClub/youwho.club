  ...
  const darkTheme = createTheme({
    ...
    palette: {
      ...
      primary: {
        ...
        text: 'white',
        themeSwitch: '#140920',
        landBG: 'linear-gradient(180deg, rgba(12,8,26,1)  0%, rgba(41,43,81,1) 100%)',
        footer: '#1E003A',
        grad: 'linear-gradient(164deg, rgba(31,0,49,1) 0%, rgba(63,77,110,1) 70%, rgba(48,42,82,1) 100%)',
        success: '#0Cb2B1',
        error: '#F675A8',
      ...
      secondary: {
        ...
        text: '#D6D6D6',
        themeSwitch: '#140920',
        landBG: 'linear-gradient(180deg, rgba(41,43,81,1) 9%, rgba(12,8,26,1) 100%)',
        footer: '#3D0062',
        success: '#B3E4E6',
        error: '#FA8FBA',
