                        ...
                        <>
                            {showOtp ?
                                <>
                                    ...
                                    />
                                    <Typography sx={{ color: 'red', fontSize: '12px' }}>{err ? err : ''}</Typography>
                                    <FlexRow sx={{ gap: 2 }}>
                                ...
                                <>
                                    ...
                                    <Box sx={{
                                        ...
                                        <MyInput icon={<Mobile />} onChange={(e) => setPhone(e.target.value)} label={'Mobile Number'} width={'100%'} id={'mobile-number'} />
                                    </Box>
                                    <Typography sx={{ color: 'red', fontSize: '12px' }}>{err ? err : ''}</Typography>
                                    <FlexRow sx={{ gap: 2 }}>
