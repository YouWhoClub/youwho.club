...
const WhatsSection = () => {
    return (
        <Box sx={{
            px: { xs: 3, sm: 10, md: 20 }, py: 10, my: 4,
            ...
            <Typography variant="h6" sx={{ color: 'primary.text', margin: 0, mb: 5, fontWeight: 500, fontSize: { xs: '22px', md: '24px' } }}>What Is NFT ?</Typography>
            <Typography variant="p" sx={{ color: 'primary.text', margin: 0, mb: 5, fontSize: { xs: '14px', sm: '16px', }, fontWeight: 400 }}>
