...
const ButtonDisabledActive = ({ onClick, text, w, px, py, disabled, icon, mt, height, prevIcon, nextIcon, fontSize, br }) => {
    return (
        <Button onClick={disabled ? undefined : onClick}
            sx={(theme) => ({
                ...
                backgroundColor: disabled ? 'primary.gray' : 'secondary.gray',
                width: w ? w : '100px',
                px: px ? px : 'unset',
                py: py ? py : 'unset',
...
export default ButtonDisabledActive;